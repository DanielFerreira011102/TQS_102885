...
function getWeatherIcon(condition, isDay) {
  switch(condition) {
    case 'Sunny':
    case 'Clear':
      return isDay ? <WiDaySunny className="condition" size={64} color={ICON_COLOR} /> : <WiNightClear className="condition" size={64} color={ICON_COLOR} />;
    case 'Partly cloudy':
      return isDay ? <WiDaySunnyOvercast className="condition" size={64} color={ICON_COLOR} /> : <WiNightPartlyCloudy className="condition" size={64} color={ICON_COLOR} />;
    case 'Cloudy':
    case 'Overcast':
      return <WiCloudy className="condition" size={64} color={ICON_COLOR} />;
    case 'Mist':
    case 'Fog':
    case 'Freezing fog':
      return <WiFog className="condition" size={64} color={ICON_COLOR} />;
    case 'Patchy rain possible':
    case 'Light rain':
    case 'Light freezing rain':
    case 'Patchy light rain':
    case 'Patchy light drizzle':
      return <WiRain className="condition" size={64} color={ICON_COLOR} />;
    case 'Moderate rain at times':
    case 'Moderate rain':
    case 'Heavy rain at times':
    case 'Heavy rain':
      return <WiShowers className="condition" size={64} color={ICON_COLOR} />;
    ...
    case 'Heavy snow':
      return <WiSnow className="condition" size={64} color={ICON_COLOR} />;
    case 'Thundery outbreaks possible':
    case 'Moderate or heavy showers of ice pellets':
    case 'Moderate or heavy rain with thunder':
      return <WiThunderstorm className="condition" size={64} color={ICON_COLOR} />;
